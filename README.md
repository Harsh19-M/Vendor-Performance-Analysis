...
*(Specific | Measurable | Achievable | Relevant | Time Bound)* <br>&<br>(Business Understanding | Data Understanding | Data Preparation | Analysis/Modeling | Evaluation | Deployment)
